function plot_strain_stress_1in1(p,q,r,U,V,W,CP1,CP2,rb,f,E,nue,d,ss,comp)
...
%=================================================================
% supports and load arrows
% [xs1,ys1,zs1] = create_supports(CP2,rb);
% [xf1,yf1,zf1] = create_arrows(CP2,f);
...
elseif (ss==2 && comp==7);  title ('principle stress \sigma_1');
elseif (ss==2 && comp==8);  title ('principle stress \sigma_2');
elseif (ss==2 && comp==9);  title ('principle stress \sigma_3');
